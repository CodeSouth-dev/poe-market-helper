...
export interface CraftingMethod {
  ...
  averageAttempts?: number; // For methods with RNG (alt spam, essence, etc.)
  successRate?: number; // Probability of success per attempt (0-1)
}
...
export interface ProfitabilityAnalysis {
  ...
  profit: number; // marketPrice - craftingCost
  profitPercentage: number; // (profit / craftingCost) * 100
...
export const CRAFTING_METHODS_TEMPLATES: Record<string, Omit<CraftingMethod, 'materials'>> = {
  alt_spam: {
